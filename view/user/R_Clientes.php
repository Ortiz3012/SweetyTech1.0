            ...
            <div class="container" style="width: 100%;">
                ...
                <?php 
                    if (isset($_POST['enviar'])) {
                        if(empty($_POST['Documento_Identificacion']) || empty($_POST['Nombre']) || empty($_POST['Apellido']) || empty($_POST['Direccion']) || empty($_POST['Telefono']) || empty($_POST['Celular']) || empty($_POST['Fecha_Nacimiento']) || empty($_POST['Id_Tipo_Documento']) || empty($_POST['Email']) || empty($_POST['pwd'])){
echo'<script type="text/javascript">
              swal({
  title: "Error el los campos",
